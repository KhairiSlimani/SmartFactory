...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "MERIAM"."CLIENT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into MERIAM.CLIENT (ID,FIRSTNAME,LASTNAME,COMPANYNAME,PHONENUMBER,EMAIL,WEBSITE,STREET,CITY,ZIPCODE,COUNTRY,BANKACCOUNTNUMBER,CREDITLIMIT) values ('8','jjj','kk','jjj',8888,'hh@jj.com','hhhhh','jjj','kkkk',888,'yyy',88,99);
...
SET DEFINE OFF;
Insert into MERIAM.EMPLOYEE (ID,FIRSTNAME,LASTNAME,SEX,BIRTHDATE,HIREDATE,ADRESSE,PHONENUMBER,SALARY,JOBTITLE,EMAIL) values ('9','f','f','female','7/1/2000','1/1/2000','r','66','66','HR Agent','rr@k.com');
Insert into MERIAM.EMPLOYEE (ID,FIRSTNAME,LASTNAME,SEX,BIRTHDATE,HIREDATE,ADRESSE,PHONENUMBER,SALARY,JOBTITLE,EMAIL) values ('99','r','r','female','7/1/2000','1/1/2000','f','8','8','Depot Employee','@.com');
Insert into MERIAM.EMPLOYEE (ID,FIRSTNAME,LASTNAME,SEX,BIRTHDATE,HIREDATE,ADRESSE,PHONENUMBER,SALARY,JOBTITLE,EMAIL) values ('777','kkk','lll','female','7/1/2000','1/1/2000','d','8','80','Laboratory Employee','@.');
Insert into MERIAM.EMPLOYEE (ID,FIRSTNAME,LASTNAME,SEX,BIRTHDATE,HIREDATE,ADRESSE,PHONENUMBER,SALARY,JOBTITLE,EMAIL) values ('888','d','d','female','7/1/2000','1/1/2000','dd','99','3','Stock Employee','3');
...
SET DEFINE OFF;
Insert into MERIAM.ORDERTAB (ORDERNUMBER,PRODUCTCODE,QUANTITYORDERED,STATUS,ORDERDATE,UNITPRICE,DISCOUNT,EXTENDEDPRICE,REQUIREDDATE,CUSTOMERID,COMMENTS) values (4,'50',5,'shipping',to_date('25-DEC-20','DD-MON-RR'),3,33,4,to_date('25-DEC-20','DD-MON-RR'),'2','aaaaaaaaa');
Insert into MERIAM.ORDERTAB (ORDERNUMBER,PRODUCTCODE,QUANTITYORDERED,STATUS,ORDERDATE,UNITPRICE,DISCOUNT,EXTENDEDPRICE,REQUIREDDATE,CUSTOMERID,COMMENTS) values (1,'55',5,'shipping',to_date('25-DEC-20','DD-MON-RR'),5,99,5,to_date('25-DEC-20','DD-MON-RR'),'2','sssss');
Insert into MERIAM.ORDERTAB (ORDERNUMBER,PRODUCTCODE,QUANTITYORDERED,STATUS,ORDERDATE,UNITPRICE,DISCOUNT,EXTENDEDPRICE,REQUIREDDATE,CUSTOMERID,COMMENTS) values (2,'55',22,'shipping',to_date('25-DEC-20','DD-MON-RR'),5,8,4,to_date('25-DEC-20','DD-MON-RR'),'2','mmmmmm');
Insert into MERIAM.ORDERTAB (ORDERNUMBER,PRODUCTCODE,QUANTITYORDERED,STATUS,ORDERDATE,UNITPRICE,DISCOUNT,EXTENDEDPRICE,REQUIREDDATE,CUSTOMERID,COMMENTS) values (11,'50',null,null,null,null,null,null,null,'8',null);
Insert into MERIAM.ORDERTAB (ORDERNUMBER,PRODUCTCODE,QUANTITYORDERED,STATUS,ORDERDATE,UNITPRICE,DISCOUNT,EXTENDEDPRICE,REQUIREDDATE,CUSTOMERID,COMMENTS) values (12,'80',4,'shipping',to_date('01-JAN-00','DD-MON-RR'),2,88,3,to_date('01-JAN-00','DD-MON-RR'),'8','zzaaa');
...
SET DEFINE OFF;
Insert into MERIAM.PROFILE (ID,PASSWORD,JOBTITLE) values ('55','aa','HR Agent');
Insert into MERIAM.PROFILE (ID,PASSWORD,JOBTITLE) values ('33','aa','Project and Services Employee');
Insert into MERIAM.PROFILE (ID,PASSWORD,JOBTITLE) values ('99','bb','Depot Employee');
Insert into MERIAM.PROFILE (ID,PASSWORD,JOBTITLE) values ('777','aa','Laboratory Employee');
REM INSERTING into MERIAM.PROJET
SET DEFINE OFF;
Insert into MERIAM.PROJET (ID,NAME,DESCRIPTION,STARTDATE,ENDDATE,BUDGET,CUSTOMERID) values ('44','hhh','hhh','1/1/2000','1/1/2000',88,'88');
...
--------------------------------------------------------
  ...
  ALTER TABLE "MERIAM"."EMPLOYEE" MODIFY ("JOBTITLE" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "MERIAM"."PROFILE" ADD CONSTRAINT "PROFILE_PK" PRIMARY KEY ("ID", "JOBTITLE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "MERIAM"."PROFILE" MODIFY ("JOBTITLE" NOT NULL ENABLE);
