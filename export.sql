--------------------------------------------------------
--  Fichier créé - jeudi-décembre-31-2020   
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "MERIAM"."PROJET_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Table BILL
--------------------------------------------------------
...
Insert into MERIAM.EMPLOYEE (ID,FIRSTNAME,LASTNAME,SEX,BIRTHDATE,HIREDATE,ADRESSE,PHONENUMBER,SALARY,JOBTITLE,EMAIL) values ('191','yasmine','sliti','female','20/05/1998','20/05/1998','ef','88','66','Project and Services Employee','yasmi.dj@gmail.com');
...
Insert into MERIAM.PROFILE (ID,PASSWORD,JOBTITLE) values ('191','191','Project and Services Employee');
REM INSERTING into MERIAM.PROJET
SET DEFINE OFF;
Insert into MERIAM.PROJET (ID,NAME,DESCRIPTION,STARTDATE,ENDDATE,BUDGET,CUSTOMERID) values ('3','zadza','sqd','05/01/2000','06/01/2000','59000000000','2');
Insert into MERIAM.PROJET (ID,NAME,DESCRIPTION,STARTDATE,ENDDATE,BUDGET,CUSTOMERID) values ('2','ijeiozad','ezfez','05/01/2000','06/01/2000','561','1');
Insert into MERIAM.PROJET (ID,NAME,DESCRIPTION,STARTDATE,ENDDATE,BUDGET,CUSTOMERID) values ('4','EZD','ZEDDD','01/01/2000','01/01/2000','555','22');
